        ...
        <div className="relative overflow-hidden rounded-xl border border-white/10 bg-zinc-900/70 shadow-xl glow-border sm:rounded-2xl sm:shadow-2xl">
            ...
            {cameraStatus === "idle" && (
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 bg-zinc-900/95 px-4 sm:gap-4">
                <motion.div
                  ...
                  className="relative flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-teal-600 shadow-lg shadow-cyan-500/30 sm:h-20 sm:w-20 sm:rounded-2xl sm:shadow-xl"
                >
            ...
            {cameraStatus === "active" && isModelLoading && (
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-zinc-900/80 px-4 backdrop-blur-sm sm:gap-3">
                <div className="relative">
                  <div className="h-8 w-8 animate-spin rounded-full border-4 border-cyan-500/30 border-t-cyan-500 sm:h-10 sm:w-10" />
                  <div className="absolute inset-0 h-8 w-8 animate-ping rounded-full bg-cyan-500/20 sm:h-10 sm:w-10" />
                </div>
          ...
          <div className="flex items-center justify-between border-t border-white/5 bg-zinc-900/60 px-3 py-1.5 text-[10px] sm:px-4 sm:py-2 sm:text-xs">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {isHandNearNose && (
                <span className="flex items-center gap-0.5 text-cyan-400 font-semibold sm:gap-1">
                  <span className="h-1 w-1 rounded-full bg-cyan-400 animate-pulse sm:h-1.5 sm:w-1.5" />
