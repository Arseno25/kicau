...
/**
 * Main orchestrator component for the camera vision system.
 * Composes camera, detection, debug, and animation sub-components.
 */
export function CameraVision() {
  ...
  const { debugInfo, isModelLoading, modelError } = useHandFaceProximity({
    videoRef,
    canvasRef,
    cameraStatus,
    debugMode,
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <div className="w-full lg:w-80">
          ...
          <motion.div
            ...
            className="mt-4 rounded-2xl border border-white/10 bg-zinc-900/60 p-5 backdrop-blur-xl"
          >
            <h3 className="mb-3 text-sm font-bold tracking-wider text-zinc-300 uppercase">
              How It Works
            </h3>
            <ol className="space-y-2 text-sm text-zinc-400">
              ...
              <li className="flex gap-2">
                ...
                ML models detect your face & hands
              </li>
              <li className="flex gap-2">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-violet-500/20 text-xs font-bold text-violet-400">
                  3
                </span>
                Move your hand close to your nose
              </li>
              <li className="flex gap-2">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-violet-500/20 text-xs font-bold text-violet-400">
                  4
                </span>
                Watch the animation trigger! 🎉
              </li>
            </ol>
          </motion.div>
        </div>
