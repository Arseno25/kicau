...
export function PoseGuide({ isVisible }: PoseGuideProps) {
  ...
  return (
    <motion.div
      ...
      className="mx-auto w-full max-w-sm rounded-xl border border-cyan-500/30 bg-cyan-500/10 px-4 py-3 backdrop-blur-sm"
    >
      <div className="flex items-center gap-3">
        ...
        <motion.div
          ...
          className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-cyan-500/20"
        >
        ...
        <div className="flex-1 text-xs sm:text-sm">
          <p className="font-semibold text-cyan-300">Cara memicu:</p>
          <p className="text-zinc-400 mt-0.5">
            Letakkan <span className="text-cyan-400">satu tangan di dekat hidung</span>
          </p>
